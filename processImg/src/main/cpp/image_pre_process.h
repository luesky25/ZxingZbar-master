...
#include <jni.h>
#include "../../../../../../develop/Android/sdk/ndk-bundle/sysroot/usr/include/jni.h"
...
(JNIEnv *, jclass jcla, jbyteArray, jint, jint, jbyteArray, jint, jint, jint, jint);
...
(JNIEnv *, jclass, jbyteArray array, jint, jint, jbyteArray);
